    ...
    return (
        <footer className="px-6 md:px-20 lg:px-32 py-10 text-center grid place-content-center">
            ...
            <div className="mt-2 flex gap-3 items-center justify-center">
                <Link href="https://github.com/satyawaniaman" className="underline underline-offset-[5px] decoration-blue-400 text-sm">Github</Link>
                <Link href="https://" className="underline underline-offset-[5px] decoration-blue-400 text-sm">My Portfolio</Link>
            </div>
            <div className="mt-4">
                <ModeToggle />
            </div>
